...
<body>
        ...
        <aside id="sidebar" class="js-sidebar">
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="appointment_management.php" class="sidebar-link"><i class="fa-solid fa-calendar"></i>
                            Appointments</a>
                    </li>
                </ul>
            </div>
    ...
    $(document).ready(function() {
       ...
       $('#appointmentTable').DataTable({
        ...
        columnDefs: [
            { targets: [0, 3, 4], className: 'dt-body-center' } // Center align for better look
        ],
        language: {
            paginate: {
                previous: "<",
